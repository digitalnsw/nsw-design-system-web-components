...
import "@digitalnsw/simple-icon/lib/simple-icon-lite.js";
import "@digitalnsw/simple-icon/lib/simple-icons.js";
import "@digitalnsw/simple-toolbar/simple-toolbar.js";
import "@digitalnsw/simple-toolbar/lib/simple-toolbar-button.js";
...
class SimpleFieldsUpload extends SimpleFieldsFieldsetBehaviors(LitElement) {
  ...
  _takeSelfie(e) {
    if (!this.camera) {
      import("@digitalnsw/simple-login/lib/simple-camera-snap.js");
  ...
  _voiceRecorder(e) {
    if (!this.voice) {
      import("@digitalnsw/voice-recorder/voice-recorder.js");
